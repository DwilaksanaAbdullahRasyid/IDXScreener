...
urlpatterns = [
    ...
    path('api/backtest-async/start/',  views.api_backtest_async_start, name='api_backtest_async_start'),
    path('api/backtest-async/status/', views.api_backtest_async_status, name='api_backtest_async_status'),
